<div id="outer">
	<div id="site_content_1" style="padding-bottom:20px;">
        ...
        <div style="float:left; width:1180px; height:40px; padding-top:40px;">
			...
			<a onclick="displayContent('fleet_positions_wet');" id='fleet_positions_wet_id_link' class="content_link">Fleet Register</a> &nbsp; 
			<a onclick="displayContent('ship_his_wet');" id='ship_his_wet_id_link' class="content_link">Ship Voys</a> &nbsp; 
			<a onclick="displayContent('ports_intelligence');" id='ports_intelligence_id_link' class="content_link">Port Specs</a> &nbsp; 
            <a onclick="displayContent('ships_coming_into_ports_wet');" id='ships_coming_into_ports_wet_id_link' class="content_link">Port Arrivals</a> &nbsp; 
            <a onclick="displayContent('live_ship_position_wet');" id='live_ship_position_wet_id_link' class="content_link">AIS Vessels</a> &nbsp; 
