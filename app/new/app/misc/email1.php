	...
	*{
	...
	<div style='text-align:left; padding:0px 5px;'>
		<table width='100%' border='0' cellpadding='0' cellspacing='0'>
			<tr>";
				if($_GET['report']=='position'){
					echo "<td width='30' style='border:0px;'><img src='http://".$_SERVER['HTTP_HOST']."/app/images/shipeta.jpg' /></td>
					<td style='border:0px;'><b style='font-size:14px;'>POSITION REPORT</b></td>";
				}else{
					echo "<td width='30' style='border:0px;'><img src='http://".$_SERVER['HTTP_HOST']."/app/images/sched.jpg' /></td>
...
$subject = "Cargospotter Fixture List";
$emailsp = explode("\n",$_POST['email']);
$emails = array();
$t = count($emailsp);
for($i=0; $i<$t; $i++){
