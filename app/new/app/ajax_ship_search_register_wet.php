...
function openMessageDialog(mid, imo, type){
	jQuery("#messageiframeshipsearchonly")[0].src="search_ajax1ve_wet.php?action=getmessages&type="+type+"&mid="+mid+"&imo="+imo+"&t="+(new Date()).getTime();
