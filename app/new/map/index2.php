...
for($i=0; $i<$t; $i++){
	...
	if($ship['DESTINATION_ETA']!="Jan 1, 1970 0:00 UTC"){
		$destination_eta = "<a class='clickable2' alt='".date("M j, 'y G:i e", str2time($ship['DESTINATION_ETA']))."' title='".date("M j, 'y G:i e", str2time($ship['DESTINATION_ETA']))."'>".substr(date("M j, 'y G:i e", str2time($ship['DESTINATION_ETA'])), 0,11)."</a>";
	}else{
						...
						<div style='padding:5px;'>
							<table style='font-family:verdana; font-size:10px;'>
								<tr>
									...
									<td width='185'><a class='clickable2' alt='".date("M j, 'y G:i e", str2time($ship['LASTSEEN_DATE']))."' title='".date("M j, 'y G:i e", str2time($ship['LASTSEEN_DATE']))."'>".substr(date("M j, 'y G:i e", str2time($ship['LASTSEEN_DATE'])), 0,11)."</a></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
					...
					$xstring .= "<td style='width:50%; background:#AAFFAA;'>
						<div style='padding:5px;'>
							<table style='font-family:verdana; font-size:10px;'>
								...
								<tr>
									<td><b>ETA:</b></td>
									<td><a class='clickable2' alt='".date("M j, 'y G:i e", str2time($ship['SIITECH_ETA']))."' title='".date("M j, 'y G:i e", str2time($ship['SIITECH_ETA']))."'>".substr(date("M j, 'y G:i e", str2time($ship['SIITECH_ETA'])), 0,11)."</a></td>
								</tr>
							</table>
						</div>
					</td>";
