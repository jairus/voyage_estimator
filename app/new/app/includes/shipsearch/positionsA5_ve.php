...
if($t5){
	...
	<table id='p_poranges3' width='1000px' style='border:1px solid #000;'>
		<tr>
			<th width='20px' style='text-align:center; background-color:#ccc;'><div style='padding:5px;'><input type='checkbox' onclick=\"checkAll('p_poranges3', this)\" ></div></th>
						...
						if(trim($status)!="DEAD"){
							...
							if(!empty($bupdate)){
								if((time()-$delydate_to)<(60*60*24*15)){
									$updates = "<img src='images/icon_dropdown_warning_broker.png' width='20' height='18' style='cursor:pointer;' onclick=\"expand('p_drop5_".$i."', '".$ships['IMO #']."', 'broker');\" id='p_drop5_".$i."_img' />";
								}else{
									$updates = "<img src='images/icon_dropdown.png' width='20' height='18' style='cursor:pointer;' onclick=\"expand('p_drop5_".$i."', '".$ships['IMO #']."', 'broker');\" id='p_drop5_".$i."_img' />";
								}
							}else{
								$updates = "<img src='images/icon_dropdown.png' width='20' height='18' style='cursor:pointer;' onclick=\"expand('p_drop5_".$i."', '".$ships['IMO #']."', 'broker');\" id='p_drop5_".$i."_img' />";
							}
							...
							echo "<tr style='background:#e5e5e5;'>
									...
									<div style='padding:5px;'>
										<table width='100%' cellpadding='0' cellspacing='0'>
											<tr>
												...
												<td style='text-align:center; width:20px;'><a class='clickable' onclick='openMapVe2(\"broker\", \"".$details."\", \"SHIPS FOUND USING BROKERSINTELLIGENCE\")'><img title='Map' alt='Map' src='images/map-icon.png'></a></td>
											</tr>
										</table>
									</div>
								</td>";
								...
								echo "<td style='text-align:center;'><div style='padding:5px;'><a onclick=\"getHistory('".$ships['IMO #']."', 'openport', '".$details."', 'SHIPS FOUND USING BROKERSINTELLIGENCE');\" alt='Last Port History' title='Last Port History' class='history_link'><img src='images/icon_plusdown_warning.png' border='0' /></a></div</td>
							...
							<tr style='width:992px; background:#fff;'>
								<td colspan='15' id='p_drop5_".$i."' style='display:none;'></td>
							</tr>";
						}
					}
