...
<div id="emaildialog" title="EMAIL REPLY"  style='display:none'>
	<iframe id='emailiframe' frameborder=0 height="100%" width="100%" style='border:0px; height:100%; width:100%'></iframe>
</div>
...
jQuery("#emaildialog").dialog({ width: 920, height: 460 });
...
function openEmailDialog(email_id, email_category){
	jQuery("#emailiframe")[0].src="search_ajax.php?action=getemail&email_id="+email_id+"&email_category="+email_category;
	jQuery("#emaildialog").dialog( { width: '920', height: jQuery(window).height()*0.9 });
		...
		<td>
			<div id="content_wrapper" style='margin-bottom:50px'>
				<div id="content_main">
                        ...
                        <tr>
                            <td valign="top" width="400">
                                <table width="400" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            function showZones(lp, dwt){
                                                ...
                                                jQuery.ajax({
                                                    type: 'POST',
                                                    url: "search_ajax.php?load_port="+lp+"&action=getzones&dwt_range="+dwt,
                                                    data:  '',
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select name="hull_type" class="selection" id='hull_type_id' style="width:200px;">
                                                <option>SINGLE HULL</option>
                                                <option selected="selected">DOUBLE HULL</option>
                                            </select>
                                    ...
                                    <tr>
                                        <td valign="top" class="title"><p>CATEGORY <strong><br />
                                        WET<br />
                                        </strong>(OIL AND DERIVITATIVES)<strong><br />
                                          </strong></p>
                                          </td>
                                  <td valign="top" id='foovt'>
                                            <select name="vessel_type[]" multiple="multiple" size="16" id='vessel_type_id' style="width:220px;">
                                            	<optgroup label="TANKER">
                                                	<option value="ASPHALT/BITUMEN TANKER">ASPHALT/BITUMEN TANKER</option>
                                                    <option value="BUNKERING TANKER">BUNKERING TANKER</option>
                                                    <option value="CHEMICAL TANKER">CHEMICAL TANKER</option>
                                                    <option value="CRUDE OIL TANKER" selected="selected">CRUDE OIL TANKER</option>
                                                    <option value="FRUIT JUICE TANKER">FRUIT JUICE TANKER</option>
                                                    ...
                                                    <option value="VEGETABLE/ANIMAL OIL TANKER">VEGETABLE/ANIMAL OIL TANKER</option>
                                                    <option value="WATER TANKER">WATER TANKER</option>
                                                    <option value="WINE TANKER">WINE TANKER</option>
                                                </optgroup>
                                            </select>
                            ...
                            <td valign="top" width="600">
                                <table width="600" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select class="valid" name="dwt_range" id='dwt_range_id' onchange='showZones(jQuery("#suggest1").val(), this.value)'>
                                                <option value="0|3">(0 - 3000) Others</option>
                                                <option value="3|10">(3001 - 10,000) Coastal</option>
                                                <option value="10|19">(10,001 - 19000) Small</option>
                                                <option value="19|30">(19,001 - 30,000) Handy</option>
                                                <option value="30|55" selected="selected">(30,001 - 55,000) MR</option>
                                                <option value="50|80">(50,000 - 80,000) Panamax / LR1</option>
                                                <option value="80|120">(80,001 - 120,000) Aframax</option>
                                                <option value="120|200">(120,001 - 200,000) Suezmax</option>
                                                <option value="200|350">(200,001 - 350,000) VLCC / VLOC</option>
                                                <option value="350|550">(350,001 - 550,000) ULCC</option>
                                            </select>
                                    ...
                                    <tr>
                                        <td valign="top" class="title">SEARCH ZONE</td>
                                        <td valign="top">
                                            <div id='zones'></div>
                            ...
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5">&nbsp;</td>
                                        <td>
                                        	<select name="p_vessel_type[]" multiple="multiple" size="16" id='p_vessel_type_id' style="width:220px;">
                                            	<optgroup label="TANKER">
                                                	<option value="ASPHALT/BITUMEN TANKER">ASPHALT/BITUMEN TANKER</option>
                                                    <option value="BUNKERING TANKER">BUNKERING TANKER</option>
                                                    <option value="CHEMICAL TANKER">CHEMICAL TANKER</option>
                                        ...
                                        <td>
                                            <div style='padding:5px;'>
                                            	...
                                            	<table id="live_ship_positions_categories" width="990">
                                                    ...
                                                    <tr>
                                                    	<td valign="top" width="20"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="ASPHALT/BITUMEN TANKER" /></div></td>
                                                        <td valign="top" width="228"><div style='padding:5px;'>ASPHALT/BITUMEN TANKER</div></td>
                                                        <td valign="top" width="20"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="BUNKERING TANKER" /></div></td>
                                                        <td valign="top" width="227"><div style='padding:5px;'>BUNKERING TANKER</div></td>
                                                        <td valign="top" width="20"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="CHEMICAL TANKER" /></div></td>
                                                        <td valign="top" width="227"><div style='padding:5px;'>CHEMICAL TANKER</div></td>
                                                        <td valign="top" width="20"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="CRUDE OIL TANKER" /></div></td>
                                                        <td valign="top" width="228"><div style='padding:5px;'>CRUDE OIL TANKER</div></td>
                                                    </tr>
                                                    <tr style="padding-top:10px;">
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="FRUIT JUICE TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>FRUIT JUICE TANKER</div></td>
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="OIL PRODUCTS TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>OIL PRODUCTS TANKER</div></td>
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="OIL/CHEMICAL TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>OIL/CHEMICAL TANKER</div></td>
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="VEGETABLE/ANIMAL OIL TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>VEGETABLE/ANIMAL OIL TANKER</div></td>
                                                    </tr>
                                                    <tr style="padding-top:10px;">
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="WATER TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>WATER TANKER</div></td>
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'><input type="checkbox" id="pos_vessel_type_id" name="pos_vessel_type[]" onclick="viewLiveShipPosition();" value="WINE TANKER" /></div></td>
                                                        <td valign="top"><div style='padding:5px;'>WINE TANKER</div></td>
                                                        <td valign="top"><div style='padding:5px 0px 5px 5px;'>&nbsp;</div></td>
                    ...
                    <!--BUNKER PRICE-->
                    <div id="mapdialogbunkerprice" title="MAP" style='display:none;'>
