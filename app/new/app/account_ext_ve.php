						...
						<td>
							<table width='100%' border='0' cellspacing='0' cellpadding='0'>
								<tr>
									...
									<td class='person' width='140'><a href='s-bis.php?action=accountview&id=".$r[$i]['id']."' class='clickable2' target='_blank'>".$r[$i]['firstname']." ".$r[$i]['lastname']."</a></td>
					...
					echo "<tr>
						<td>
							<table width='100%' border='0' cellspacing='0' cellpadding='0'>
								<tr>
									<td width='60'>".$image."</td>
									<td class='person' width='140'><a href='s-bis.php?action=accountview&id=".$r[$i]['id']."' class='clickable'>".$r[$i]['firstname']." ".$r[$i]['lastname']."</a></td>
									<td class='status' width='260' align='right'>
								...
								echo "<form id='aadduser".$r[$i]['id']."'>
									<table cellpadding='0' cellspacing='2'>
										...
										<tr>
											...
											<td valign='top' class='person'><a href='s-bis.php?action=accountview&id=".$r[$i]['id']."'>".$r[$i]['firstname']." ".$r[$i]['lastname']."</a></td>
