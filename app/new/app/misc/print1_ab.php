...
if($t){
	...
	<table width='1000px' style='border:1px solid #000;'>
		<tr>
			...
			<th width='110px' style='background:#BCBCBC; color:#333333; text-align:left;'><div style='padding:5px;'>ETA</div></th>
			...
			<th width='180px' style='background:#BCBCBC; color:#333333; text-align:left;'><div style='padding:5px;'>Manager / Owner</div></th>
			<th width='150px' style='background:#BCBCBC; color:#333333; text-align:left;'><div style='padding:5px;'>Category</div></th>
	...
	for($i=0; $i<$t; $i++){
		...
		if(trim($xvas['data'])){
			...
			$summer_dwt = number_format(str_replace("tons", "", getValue($xvas['data'], 'SUMMER_DWT')));
			$build = getValue($xvas['data'], 'BUILD');
			$vessel_type = getValue($xvas['data'], 'VESSEL_TYPE');
			$draught = str_replace("m", "", getValue($xvas['data'], 'DRAUGHT'));
			$dwt = $ships['xvas_summer_dwt'];
				...
				<td>
					<div style='padding:5px;'>
						<table cellpadding='0' cellspacing='0' width='100%'>
							<tr>
								<td width='25' style='border:0px;'>".$ship_img."</td>
								<td class='z_text01' style='border:0px;'><b>".$ship_name."</b></td>
							</tr>
						</table>
					</div>
				</td>
				<td style='text-align:right;' class='z_text01'><div style='padding:5px;'>".$destination."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$destination_eta."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$hull_type."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$summer_dwt."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$build."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$operator."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$vessel_type."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$dwt."</div></td>
				<td class='z_text01'><div style='padding:5px;'>".$draught."</div></td>
