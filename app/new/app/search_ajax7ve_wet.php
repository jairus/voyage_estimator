...
if($sqlext){
	$sql = "SELECT 
		...
		_xvas_siitech_cache_wet AS siitech INNER JOIN _xvas_parsed2 AS xvas ON siitech.xvas_imo=xvas.imo 
	...
	if($_SESSION['liveShipPositionReg']){
		echo "<table width='100%'>
			...
			<tr style='background:#e5e5e5;'>
				<td><div style='padding:5px; text-align:center;'><iframe src='map/map_live_ship_position.php' width='990' height='700' frameborder='0'></iframe></div></td>
			</tr>
		</table>";
	}else{
		echo "<table width='100%'>
