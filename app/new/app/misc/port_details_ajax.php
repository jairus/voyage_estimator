			...
			<td width="300">
				<table width="300" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><input type="text" id="ship_agent_id" name="ship_agent" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $ship_agent; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
			...
			<td width="280" valign="top">
				<table width="280" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><input type="text" id="company_name_id" name="company_name" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $company_name; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Business Type</td>
						<td><input type="text" id="business_type_id" name="business_type" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $business_type; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Address</td>
						<td><input type="text" id="address_id" name="address" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $address; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>City</td>
						<td><input type="text" id="city_id" name="city" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $city; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Postal Code</td>
						<td><input type="text" id="postal_code_id" name="postal_code" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $postal_code; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Country</td>
						<td><input type="text" id="country_id" name="country" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $country; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Fax</td>
						<td><input type="text" id="fax_id" name="fax" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $fax; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Website</td>
						<td><input type="text" id="website_id" name="website" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $website; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					...
					<tr>
						<td>First Name</td>
						<td><input type="text" id="first_name_id" name="first_name" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $first_name; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Last Name</td>
						<td><input type="text" id="last_name_id" name="last_name" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $last_name; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Email Address</td>
						<td><input type="text" id="email_address_id" name="email_address" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $email_address; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Skype ID</td>
						<td><input type="text" id="skype_id" name="skype" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $skype; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>Yahoo ID</td>
						<td><input type="text" id="yahoo_id" name="yahoo" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $yahoo; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2" height="5">&nbsp;</td>
					</tr>
					<tr>
						<td>MSN ID</td>
						<td><input type="text" id="msn_id" name="msn" style="width:150px; border:1px solid #CCCCCC; padding:3px;" value="<?php echo $msn; ?>" /></td>
					</tr>
				</table>
			</td>
		</tr>
