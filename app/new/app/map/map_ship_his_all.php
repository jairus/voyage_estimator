...
$t = count($_SESSION['shipsReg']);

$ships = array();
for($i=0; $i<$t; $i++){
	$print = array();

	$ais_id = $_SESSION['shipsReg'][$i]['id'];
	...
	$sql_bi  = "SELECT * FROM `_messages` WHERE `imo`='".$ais['xvas_imo']."' AND type='network' AND user_email in ( 
	...
	$print['true_heading'] = $true_heading;
	$print['siitech_latitude'] = $ais['siitech_latitude'];
	$print['siitech_longitude'] = $ais['siitech_longitude'];
...
for($i1=0; $i1<$t1; $i1++){
    ?> var lonLat = new OpenLayers.LonLat( <?php echo $ships[0]['siitech_longitude']; ?>, <?php echo $ships[0]['siitech_latitude']; ?> ).transform(epsg4326, projectTo); <?php
}
?>
...
for($i1=0; $i1<$t1; $i1++){
	...
	var feature = new OpenLayers.Feature.Vector(
		new OpenLayers.Geometry.Point( <?php echo $ships[$i1]['siitech_longitude']; ?>, <?php echo $ships[$i1]['siitech_latitude']; ?> ).transform(epsg4326, projectTo),
		{description:"<?php echo $ships[$i1]['xstring']; ?>"} ,
		{externalGraphic: '<?php
		if(0>=$ships[$i1]['true_heading']){
			echo 'ship0.png';
		}else if(15>=$ships[$i1]['true_heading']){
			echo 'ship15.png';
		}else if(30>=$ships[$i1]['true_heading']){
			echo 'ship30.png';
		}else if(45>=$ships[$i1]['true_heading']){
			echo 'ship45.png';
		}else if(60>=$ships[$i1]['true_heading']){
			echo 'ship60.png';
		}else if(75>=$ships[$i1]['true_heading']){
			echo 'ship75.png';
		}else if(90>=$ships[$i1]['true_heading']){
			echo 'ship90.png';
		}else if(105>=$ships[$i1]['true_heading']){
			echo 'ship105.png';
		}else if(120>=$ships[$i1]['true_heading']){
			echo 'ship120.png';
		}else if(135>=$ships[$i1]['true_heading']){
			echo 'ship135.png';
		}else if(150>=$ships[$i1]['true_heading']){
			echo 'ship150.png';
		}else if(165>=$ships[$i1]['true_heading']){
			echo 'ship165.png';
		}else if(180>=$ships[$i1]['true_heading']){
			echo 'ship180.png';
		}else if(195>=$ships[$i1]['true_heading']){
			echo 'ship195.png';
		}else if(210>=$ships[$i1]['true_heading']){
			echo 'ship210.png';
		}else if(225>=$ships[$i1]['true_heading']){
			echo 'ship225.png';
		}else if(240>=$ships[$i1]['true_heading']){
			echo 'ship240.png';
		}else if(255>=$ships[$i1]['true_heading']){
			echo 'ship255.png';
		}else if(270>=$ships[$i1]['true_heading']){
			echo 'ship270.png';
		}else if(285>=$ships[$i1]['true_heading']){
			echo 'ship285.png';
		}else if(300>=$ships[$i1]['true_heading']){
			echo 'ship300.png';
		}else if(315>=$ships[$i1]['true_heading']){
			echo 'ship315.png';
		}else if(330>=$ships[$i1]['true_heading']){
			echo 'ship330.png';
		}else if(345>=$ships[$i1]['true_heading']){
			echo 'ship345.png';
		}else if(360>=$ships[$i1]['true_heading']){
			echo 'ship360.png';
		}else{
			echo 'ship270.png';
		}
